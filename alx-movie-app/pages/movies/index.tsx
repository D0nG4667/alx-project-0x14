...
const Movies: React.FC<MProps> = () => {
 ...
 const fetchMovies = useCallback(async () => {
  ...
  useEffect(() => {
    ...
    try {
      await fetchMovies(); // fetchMovies handles setState internally
    } catch (error) {
      console.error(error);
    }
  };
  ...
  <div className="py-16">
    <div className="flex flex-col md:flex-row justify-between mb-4 items-center space-x-0 md:space-x-4">
      ...
      <select title="select movie year"
    ...
    {/* Movies output */}
    <div className="grid grid-cols-2 gap-6 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 mt-10">
      {
    ...
    <div className="flex justify-end space-x-4 mt-6 py-8">
